...
export class ProcesadorIntelCoreI914900Page implements OnInit {
  ...
  id_producto: number = 27; // Reemplaza con el ID del producto real
  nombreproducto: string = 'Procesador Intel® Core™ i9-14900'; // Nombre del producto
  precio: number = 914560; // Precio del producto
  imagen: string = 'https://media.spdigital.cl/thumbnails/products/jyc8ynv8_f836da9b_thumbnail_512.jpg'; // Ruta de la imagen del producto
