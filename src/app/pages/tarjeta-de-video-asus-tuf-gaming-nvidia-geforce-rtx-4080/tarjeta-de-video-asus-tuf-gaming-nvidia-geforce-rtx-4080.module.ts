...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    TarjetaDeVideoASUSTUFGAMINGNvidiaGeforceRtx4080PageRoutingModule
  ],
  declarations: [TarjetaDeVideoASUSTUFGAMINGNvidiaGeforceRtx4080Page]
})
export class TarjetaDeVideoASUSTUFGAMINGNvidiaGeforceRtx4080PageModule {}
